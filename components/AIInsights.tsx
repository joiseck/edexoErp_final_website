      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
          <div className="space-y-6 sm:space-y-8">
            <ScrollReveal variant="fade-up" width="fit-content">
            ...
            <ScrollReveal variant="fade-up" width="100%" delay={0.2}>
            ...
            <ScrollReveal variant="fade-up" width="100%" delay={0.4}>
            ...
            <div className="space-y-3 sm:space-y-4 pt-4">
              {[
                ...
                <ScrollReveal key={i} variant="fade-up" delay={0.1 * i + 0.6} width="100%">
                  <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm font-bold text-slate-300">
          ...
          <div className="relative group">
            {/* The Chat Mockup */}
            <ScrollReveal variant="scale-up" width="100%" delay={0.4}>
