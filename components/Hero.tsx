      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center max-w-4xl mx-auto mb-12 space-y-4">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-3 px-5 py-2.5 bg-gradient-to-r from-white to-slate-50 rounded-full shadow-xl border border-slate-100/50 mb-4 group hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
          >
          ...
          <div className="relative">
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-blue-950 leading-[0.95] tracking-tighter mb-4 relative z-10"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 left-0 w-full h-1 bg-gradient-to-r from-transparent via-orange-400 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000"
            ></motion.div>
          </div>
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium tracking-wide"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-3 sm:pt-4 group"
          >
            <button
              onClick={onBookDemo}
        ...
        <div className="relative mt-8 sm:mt-12 md:mt-16 group">
          <motion.div
            ...
            className="relative z-10 mx-auto max-w-4xl rounded-[2.5rem] bg-gradient-to-br from-slate-900 to-slate-800 p-2 sm:p-3 shadow-[0_80px_150px_-40px_rgba(30,58,138,0.4)] border-4 border-white/20 group-hover:border-white/40 transition-all duration-700 hover:-translate-y-4"
          >
          ...
          <motion.div
            ...
            className="absolute -left-4 sm:-left-16 top-1/4 sm:top-1/4 glass bg-gradient-to-br from-white/90 to-white/70 p-3 sm:p-4 md:p-6 rounded-2xl shadow-2xl hidden lg:block animate-float" style={{ animationDelay: '0s' }}
          >
          ...
          <motion.div
            ...
            className="absolute -right-4 sm:-right-16 bottom-1/4 sm:bottom-1/4 glass bg-gradient-to-br from-white/90 to-white/70 p-3 sm:p-4 md:p-6 rounded-2xl shadow-2xl hidden lg:block animate-float" style={{ animationDelay: '2s' }}
          >
