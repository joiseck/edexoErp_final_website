     ...
     <section className="py-16 sm:py-20 md:py-24 bg-white overflow-hidden" id="solutions">
       <div className="max-w-7xl mx-auto px-4">
         ...
         <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-16 items-start">
           ...
           {/* Feature Display */}
           <div className="w-full lg:w-2/3 bg-slate-50 rounded-2xl sm:rounded-[3rem] p-6 sm:p-8 md:p-16 relative overflow-hidden min-h-[400px] sm:min-h-[500px] lg:min-h-[600px]">
