     ...
     <section className="py-12 sm:py-16 bg-slate-900 text-white overflow-hidden relative" id="modules">
       <div className="max-w-7xl mx-auto px-4 relative">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
           {modules.map((m) => (
             <div key={m.id} className="group relative bg-white/[0.03] border border-white/10 p-4 sm:p-6 rounded-2xl sm:rounded-3xl hover:bg-white/[0.05] hover:border-blue-500/50 transition-all duration-300">
