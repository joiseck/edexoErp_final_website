           ...
           <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
               {[
                 ...
                 <div key={i} className="group bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-lg sm:shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden relative">
                   {/* Animated Background */}
                 ...
                 <div className="space-y-6 sm:space-y-8">
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                     {[
                       ...
                       <div key={i} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 rounded-lg sm:rounded-xl border border-white/20 group-hover:bg-white/20 transition-all duration-300 hover:border-orange-400/50">
